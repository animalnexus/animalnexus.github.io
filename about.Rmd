...
If you're interested in contributing functionality and/or coding to this project, check out our project on <a href = 'http://github.com/animalnexus/feedr/' target = 'blank'>GitHub</a>.
...
The R package provides all the functionality and is used by the web-app. Users familiar with R can download and install the R package, users who prefer a graphical user-interface can access most of the same functionality through the animal__nexus__ webapp.
